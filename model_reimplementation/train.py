...
def create_model(model_to_run, cfg, n_base_feat, n_aux_feat):
  ...
  elif model_to_run == "AuxDrop_ODL_DirectedInAuxLayer_RandomOtherLayer":
  ...
  elif model_to_run == "AuxDrop_ODL_RandomAllLayer":
            return AuxDrop_ODL_RandomAllLayer(
                    features_size=n_base_feat,
                    max_num_hidden_layers=cfg['max_num_hidden_layers'],
                    qtd_neuron_per_hidden_layer=cfg['qtd_neuron_per_hidden_layer'],
                    n_classes=cfg['n_classes'],
  ...
  elif model_to_run == "AuxDrop_ODL_RandomInAuxLayer":
            return AuxDrop_ODL_RandomInAuxLayer(
                  features_size=n_base_feat,
                  max_num_hidden_layers=cfg['max_num_hidden_layers'],
                  qtd_neuron_per_hidden_layer=cfg['qtd_neuron_per_hidden_layer'],
                  n_classes=cfg['n_classes'],
  ...
  elif model_to_run == "AuxDrop_ODL_RandomInFirstLayer_AllFeatToFirst":
